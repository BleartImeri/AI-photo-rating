      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-card space-y-4">
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-border bg-background hover:bg-secondary transition-colors font-semibold text-sm disabled:opacity-50"
          >
